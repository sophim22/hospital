...
if (strlen($_SESSION['id'] == 0)) {
	...
	if (isset($_POST['submit'])) {
		...
		$stmt = $con->prepare("INSERT INTO doctorspecialization (specialization) VALUES (?)");
	...
	if (isset($_GET['del'])) {
		$sid = $_GET['id'];
		$stmt = $con->prepare("DELETE FROM doctorspecialization WHERE id = ?");
												...
												<div class="panel-body">
													...
													<form role="form" name="dcotorspcl" method="post">
														<div class="form-group">
															...
															<input type="text" id="dtsp" name="doctorspecialization" class="form-control" placeholder="Enter Doctor Specialization">
														</div>
